const { Builder, By, Capabilities, Key } = require('selenium-webdriver');
  ...
  class AutoPage {
 	constructor(url) {
		...
		this.exploreButton_path = "//*[@id=\"main\"]/div[1]/div[1]/section/div/div[2]/div/div[2]/div/div[2]/div/a"
	}
	...
	async exploreButton(){
	let explore = await driver2.findElement(By.xpath(this.exploreButton_path));
    explore.click();
